...
export const day24Modules: Record<string, Day23ModuleConfig> = {
    ...
    analyticsHub: {
        ...
        description:
            'Admin/Principal web analytics center for attendance, leave, notices, timetable health, and school operations. Values remain empty until real school data is available.',
        metrics: [
            { label: 'Attendance Trend', value: 'No data', helper: 'Shown after attendance records are available' },
            { label: 'Teacher Attendance', value: 'No data', helper: 'Shown after teacher submissions are available' },
            { label: 'Student Attendance', value: 'No data', helper: 'Shown after student attendance is recorded' },
            { label: 'Leave Overview', value: 'No data', helper: 'Shown after leave requests are available' },
        ],
        filters: [
            { label: 'Period', value: 'Daily' },
            { label: 'Scope', value: 'Whole School' },
            { label: 'Audience', value: 'Admin + Principal' },
        ],
        actions: [
            { icon: '📈', title: 'Attendance Trend', body: 'Displays real attendance movement when daily attendance records exist.', status: 'Data based' },
            { icon: '👩‍🏫', title: 'Teacher Attendance', body: 'Displays teacher attendance and submission visibility when records exist.', status: 'Data based' },
            { icon: '👨‍🎓', title: 'Student Attendance', body: 'Displays student attendance coverage when class records exist.', status: 'Data based' },
            { icon: '📝', title: 'Leave Overview', body: 'Displays leave counts and approval status when leave requests exist.', status: 'Data based' },
            { icon: '📣', title: 'Notices Published', body: 'Displays published school notices when notice records exist.', status: 'Data based' },
            { icon: '🕒', title: 'Timetable Health', body: 'Displays timetable publish and conflict health when timetable records exist.', status: 'Data based' },
        ],
        tableTitle: 'Analytics availability',
        tableDescription: 'Sections below stay business-friendly and show empty states instead of synthetic metrics when school data is unavailable.',
        columns: [
            { key: 'area', label: 'Area' },
            { key: 'signal', label: 'Current Signal' },
            { key: 'source', label: 'Data Source' },
            { key: 'message', label: 'Empty State Message' },
        ],
        rows: [
            { area: 'Attendance Trend', signal: 'No data available', source: 'Attendance records', message: 'Attendance trend will appear after teachers submit attendance.' },
            { area: 'Teacher Attendance', signal: 'No data available', source: 'Teacher submissions', message: 'Teacher attendance will appear after submission records exist.' },
            { area: 'Student Attendance', signal: 'No data available', source: 'Student attendance', message: 'Student attendance will appear after class attendance is recorded.' },
            { area: 'Leave Overview', signal: 'No data available', source: 'Leave requests', message: 'Leave overview will appear after leave requests are submitted.' },
            { area: 'Notices Published', signal: 'No data available', source: 'School notices', message: 'Published notices will appear after Admin/Principal creates notices.' },
            { area: 'Timetable Health', signal: 'No data available', source: 'Timetable operations', message: 'Timetable health will appear after timetable generation or import.' },
        ],
        validationTitle: 'Analytics data readiness',
        validations: [
            { label: 'Attendance Trend', status: 'Waiting for data' },
            { label: 'Teacher Attendance', status: 'Waiting for data' },
            { label: 'Student Attendance', status: 'Waiting for data' },
            { label: 'Leave Overview', status: 'Waiting for data' },
            { label: 'Notices Published', status: 'Waiting for data' },
            { label: 'Timetable Health', status: 'Waiting for data' },
        ],
        nextSteps: [],
    },
    rolloutReadiness: {
