...
export const portalRoutes: PortalRoute[] = [
  ...
  { icon: '💰', label: 'Fee Reminder', href: '/finance/fee-reminders', description: 'Upload and send parent fee reminders', roles: ['ADMIN', 'PRINCIPAL'], group: 'Daily Work' },
  ...
  { icon: '🔐', label: 'User Credentials', href: '/user-credentials', description: 'Download teacher and student temporary credentials', roles: ['ADMIN', 'PRINCIPAL'], group: 'Setup' },
